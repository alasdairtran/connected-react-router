...
import { ConnectedRouter, connectRouter, routerMiddleware } from "../src";
import { LOCATION_CHANGE, onLocationChanged } from "../src/actions";
        ...
        <Provider store={store}>
          <ConnectedRouter
            stateCompareFunction={(storeState, historyState) => {
              ...
              return (
                JSON.stringify(storeState) === JSON.stringify(historyState)
              );
            }}
            {...props}
          >
